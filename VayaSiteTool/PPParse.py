# PP file is the file contain Vaya fixture's information
# Such as model name, model description, footprint, firmware version and fixture photo
...
def ParsePP (filename):
    ...
    with open(filename, 'rb') as f:
        ...
        # The location of the key information in the file is fixed.
        # you can open the file in ultraedit to check.
        FixtureName = ""
