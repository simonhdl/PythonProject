...
["dart.convert", "dart:convert", , P, {
  ...
  }, "call$1", "_defaultToEncodable$closure", 2, 0, 4],
  _JsonMap: {
...
["", "piratebadge.dart", , A, {
  "^": "",
  main: [function() {
    var inputField, t1, onError, result, t2;
    inputField = document.querySelector("#inputName");
    t1 = J.get$onInput$x(inputField);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(A.updateBadge$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.querySelector("#generateButton");
    $.genButton = t1;
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(A.generateBadge$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    $.badgeNameElement = document.querySelector("#badgeName");
    t1 = W.HttpRequest_getString("piratenames.json", null, null).then$1(A.PirateName__parsePirateNamesFromJSON$closure()).then$1(new A.main_closure(inputField));
    onError = new A.main_closure0();
    result = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
    t2 = result._zone;
    if (t2 !== C.C__RootZone)
  ...
  }, "call$1", "updateBadge$closure", 2, 0, 7],
  generateBadge: [function(e) {
    A.setBadgeName(A.PirateName$(null, null));
  }, "call$1", "generateBadge$closure", 2, 0, 7],
  setBadgeName: function(newName) {
    ...
    window.localStorage.setItem("pirateName", C.JsonCodec_null_null.encode$1(P.LinkedHashMap_LinkedHashMap$_literal(["f", newName._firstName, "a", newName._appellation], null, null)));
  },
  getBadgeNameFromStorage: function() {
    var storedName, t1;
    storedName = window.localStorage.getItem("pirateName");
    if (storedName != null) {
      t1 = new A.PirateName(null, null);
      t1.PirateName$fromJSON$1(storedName);
      return t1;
    } else
      return;
  },
  main_closure: {
    "^": "Closure:11;inputField_0",
    call$1: function(_) {
  ...
  PirateName: {
    "^": "Object;_firstName,_appellation",
    toString$0: function(_) {
    ...
    PirateName$2$appellation$firstName: function(appellation, firstName) {
      ...
      if (firstName == null) {
        ...
        this._firstName = J.$index$asx(t1, $.get$PirateName_indexGen().nextInt$1(J.get$length$asx(t1)));
      } else
        this._firstName = firstName;
      t1 = $.get$PirateName_appellations();
      this._appellation = J.$index$asx(t1, $.get$PirateName_indexGen().nextInt$1(J.get$length$asx(t1)));
    },
    PirateName$fromJSON$1: function(jsonString) {
      var storedName, t1;
      storedName = C.JsonCodec_null_null.decode$1(jsonString);
      t1 = J.getInterceptor$asx(storedName);
      this._firstName = t1.$index(storedName, "f");
      this._appellation = t1.$index(storedName, "a");
    },
    static: {"^": "PirateName_indexGen,PirateName_names,PirateName_appellations", PirateName$: function(appellation, firstName) {
        ...
        var pirateNames, t1;
        pirateNames = C.JsonCodec_null_null.decode$1(jsonString);
      ...
      }, "call$1", "PirateName__parsePirateNamesFromJSON$closure", 2, 0, 8]}
  }
},
1],
]);
