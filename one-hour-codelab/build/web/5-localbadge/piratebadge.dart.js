...
["", "piratebadge.dart", , A, {
  "^": "",
  main: [function() {
    var t1 = J.get$onInput$x(document.querySelector("#inputName"));
  ...
  }, "call$1", "updateBadge$closure", 2, 0, 6],
  generateBadge: [function(e) {
    A.setBadgeName(A.PirateName$(null, null));
  }, "call$1", "generateBadge$closure", 2, 0, 6],
  ...
  PirateName: {
    ...
    PirateName$2$appellation$firstName: function(appellation, firstName) {
      ...
      if (firstName == null) {
        ...
        t2 = $.get$PirateName_indexGen().nextInt$1(10);
        if (t2 < 0 || t2 >= 10)
          return H.ioore(t1, t2);
